...
public interface PlayerInfoRepository extends JpaRepository<PlayerInfo, UUID> {
    ...
    List<PlayerInfo> findByCreatedBeforeRacenetChange(boolean racenetChange);
    Optional<PlayerInfo> findByRacenetAndCreatedBeforeRacenetChange(String name, boolean racenetChange);

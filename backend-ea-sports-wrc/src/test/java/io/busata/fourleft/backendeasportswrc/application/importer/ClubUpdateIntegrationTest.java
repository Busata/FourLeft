...
class ClubUpdateIntegrationTest extends AbstractIntegrationTest {
    ...
    @Test
    @DataSet(provider = BaseDataSet.class, cleanBefore = true, skipCleaningFor = "schema_version")
    public void testClubUpdateSameChampionship() throws InterruptedException {
        ...
        assertThat(championshipsByClubId).first().extracting(Championship::getSettings).extracting(ChampionshipSettings::getName).isEqualTo("WRC Creation");
    }

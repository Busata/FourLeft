...
public class MergeResultsViewFixedPointsFactory {
    ...
    public ViewPointsTo createFixedPoints(MergeResultsView resultsView, FixedPointsCalculator calc) {
        return new ViewPointsTo(resultsView.getResultViews().stream().map(tier -> {
            return createPointsList(resultsView, calc, tier);
        }).collect(Collectors.toList()));
    }

    private SinglePointListTo createPointsList(MergeResultsView resultsView, FixedPointsCalculator calc, SingleClubView singleClubView) {
